...
<template>
    <div class="container py-20">
        <h1 class="text-5xl mb-4">Privacy Policy</h1>
        <p>Last updated: June 28, 2023</p>
        <p>This Privacy Policy describes our policies and procedures regarding the collection, use, and disclosure of
            your information when you use the service. It also informs you about your privacy rights and how the law
            protects you.</p>
        <p>We use your personal data to provide and improve the service. By using the service, you agree to the
            ...
            generated with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/"
                                              target="_blank">TermsFeed Privacy Policy Generator</a>.</p>
        <h1 class="text-5xl mb-4">Interpretation and Definitions</h1>
        <h2 class="text-4xl mb-4">Interpretation</h2>
        <p>The capitalized words used in this Privacy Policy have specific meanings as defined under certain conditions.
            These definitions shall have the same meaning regardless of whether they appear in the singular or plural
            form.</p>
        <h2 class="text-4xl mb-4">Definitions</h2>
        ...
        <ul>
            ...
            <li>
                <p><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common
                    ...
                    or other securities entitled to vote for the election of directors or other managing authority.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as "the Company," "we," "us," or "our" in this agreement)
                    refers to Skipper, Via Nuova per Pisa, 5901 55100 Santa Maria del Giudice (LU).</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Device</strong> means any device that can access the service, such as a computer, cellphone,
                    or digital tablet.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Service Provider</strong> means any natural or legal person who processes data on behalf of
                    the company. It refers to third-party companies or individuals employed by the company to facilitate
                    the service, provide the service on behalf of the company, perform services related to the service,
                    or assist the company in analyzing how the service is used.</p>
            </li>
            <li>
                <p><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of
                    the service or from the service infrastructure itself (e.g., the duration of a page visit).</p>
            </li>
            <li>
                <p><strong>Website</strong> refers to Trattoria Skipper, accessible from <a href="trattoriaskiper.com"
        ...
        <h1 class="text-5xl mb-4">Collecting and Using Your Personal Data</h1>
        <h2 class="text-4xl mb-4">Types of Data Collected</h2>
        <h3 class="text-3xl mb-4">Personal Data</h3>
        ...
        <h3 class="text-3xl mb-4">Usage Data</h3>
        ...
        <h3 class="text-3xl mb-4">Tracking Technologies and Cookies</h3>
        ...
        <h2 class="text-4xl mb-4">Use of Your Personal Data</h2>
        ...
        <h2 class="text-4xl mb-4">Retention of Your Personal Data</h2>
        ...
        <h2 class="text-4xl mb-4">Transfer of Your Personal Data</h2>
        ...
        <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
            ...
            information.</p>
        <h2 class="text-4xl mb-4">Delete Your Personal Data</h2>
        ...
        <p>Please note, however, that We may need to retain certain information when we have a legal obligation or
            lawful basis
            to do so.</p>
        <h2 class="text-4xl mb-4">Disclosure of Your Personal Data</h2>
        <h3 class="text-3xl mb-4">Business Transactions</h3>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We
            ...
            Policy.</p>
        <h3 class="text-3xl mb-4">Law enforcement</h3>
        ...
        <h3 class="text-3xl mb-4">Other legal requirements</h3>
        ...
        <h2 class="text-4xl mb-4">Security of Your Personal Data</h2>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the
            Internet,
            or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to
            protect Your
            Personal Data, We cannot guarantee its absolute security.</p>
        <h1 class="text-5xl mb-4">Children's Privacy</h1>
        ...
        <h1 class="text-5xl mb-4">Links to Other Websites</h1>
        ...
        <h1 class="text-5xl mb-4">Changes to this Privacy Policy</h1>
        ...
        <h1 class="text-5xl mb-4">Contact Us</h1>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
            <li>By email: info@trattoriaskipper.com</li>
        </ul>
    </div>
</template>
